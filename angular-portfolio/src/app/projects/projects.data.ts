...
export const PROJECTS: Project[] = [
  ...
  // ─── Education ───────────────────────────────────────────────────────
  {
    ...
    description:
      "An eight week online certificate for people starting from zero, written for the American University of Beirut. I wrote the whole thing: the syllabus, the lessons, the assessments, and the notes future instructors teach it from. It covers using AI for everyday work: automating tasks, analysing data, making things, and knowing where the limits are. The examples are local, including ones in Arabic.",
